...
curl -sSL  --compressed "https://hosts-file.net/emd.txt" | sed -e 's/#.*$//g; s/^ *//; s/ *$//; /^$/d; /^\s*$/d; /localhost$/d' | cut -f2 >> {$curltemp,,}
curl -sSL  --compressed "https://hosts-file.net/exp.txt" | sed -e 's/#.*$//g; s/^ *//; s/ *$//; /^$/d; /^\s*$/d; /localhost$/d' | cut -f2 >> {$curltemp,,}
curl -sSL  --compressed "https://hosts-file.net/fsa.txt" | sed -e 's/#.*$//g; s/^ *//; s/ *$//; /^$/d; /^\s*$/d; /localhost$/d' | cut -f2 >> {$curltemp,,}
curl -sSL  --compressed "https://hosts-file.net/grm.txt" | sed -e 's/#.*$//g; s/^ *//; s/ *$//; /^$/d; /^\s*$/d; /localhost$/d' | cut -f2 >> {$curltemp,,}
curl -sSL  --compressed "https://hosts-file.net/hjk.txt" | sed -e 's/#.*$//g; s/^ *//; s/ *$//; /^$/d; /^\s*$/d; /localhost$/d' | cut -f2 >> {$curltemp,,}
curl -sSL  --compressed "https://hosts-file.net/mmt.txt" | sed -e 's/#.*$//g; s/^ *//; s/ *$//; /^$/d; /^\s*$/d; /localhost$/d' | cut -f2 >> {$curltemp,,}
curl -sSL  --compressed "https://hosts-file.net/psh.txt" | sed -e 's/#.*$//g; s/^ *//; s/ *$//; /^$/d; /^\s*$/d; /localhost$/d' | cut -f2 >> {$curltemp,,}
curl -sSL  --compressed "https://hosts-file.net/pup.txt" | sed -e 's/#.*$//g; s/^ *//; s/ *$//; /^$/d; /^\s*$/d; /localhost$/d' | cut -f2 >> {$curltemp,,}
...
curl -sSL  --compressed "https://raw.githubusercontent.com/anudeepND/blacklist/master/adservers.txt" | sed -e 's/#.*$//g; /^\s*$/d' | cut -d' ' -f2 >> {$curltemp,,}
curl -sSL  --compressed "https://raw.githubusercontent.com/anudeepND/blacklist/master/CoinMiner.txt" | sed -e 's/#.*$//g; /^\s*$/d' | cut -d' ' -f2 >> {$curltemp,,}
curl -sSL  --compressed "https://raw.githubusercontent.com/anudeepND/blacklist/master/facebook.txt" | sed -e 's/#.*$//g; /^\s*$/d' | cut -d' ' -f2 >> {$curltemp,,}
curl -sSL  --compressed "https://raw.githubusercontent.com/anudeepND/youtubeadsblacklist/master/domainlist.txt" >> {$curltemp,,}
curl -sSL  --compressed "https://raw.githubusercontent.com/crazy-max/WindowsSpyBlocker/master/data/hosts/spy.txt" | sed -e 's/#.*$//g; /^\s*$/d' | cut -d' ' -f2 >> {$curltemp,,}
...
curl -sSL  --compressed "https://raw.githubusercontent.com/StevenBlack/hosts/master/data/add.2o7Net/hosts" | cut -d' ' -f2 | awk '/[a-z]$/{print $0}' >> {$curltemp,,}
curl -sSL  --compressed "https://raw.githubusercontent.com/StevenBlack/hosts/master/data/add.Risk/hosts" | cut -d' ' -f2 | awk '/[a-z]$/{print $0}' >> {$curltemp,,}
curl -sSL  --compressed "https://raw.githubusercontent.com/StevenBlack/hosts/master/data/add.Spam/hosts" | cut -d' ' -f2 | awk '/[a-z]$/{print $0}' >> {$curltemp,,}
curl -sSL  --compressed "https://raw.githubusercontent.com/StevenBlack/hosts/master/data/KADhosts/hosts" | sed -e 's/#.*$//g; /^\s*$/d; s/\/\///g' | cut -d' ' -f2 | awk '/[a-z]$/{print $0}' >> {$curltemp,,}
curl -sSL  --compressed "https://raw.githubusercontent.com/StevenBlack/hosts/master/data/UncheckyAds/hosts" | cut -d' ' -f2 | awk '/[a-z]$/{print $0}' >> {$curltemp,,}
curl -sSL  --compressed "https://raw.githubusercontent.com/StevenBlack/hosts/master/hosts" | grep -v 'localhost' | grep -v 'ip6-' | grep -v local | grep -v broadcasthost| sed -e 's/#.*$//g; /^\s*$/d; s/\/\///g' | cut -d' ' -f2 | awk '/[a-z]$/{print $0}' >> {$curltemp,,}
curl -sSL  --compressed "https://raw.githubusercontent.com/vokins/yhosts/master/hosts" | grep -v '#' | cut -d' ' -f2 | awk '/[a-z]$/{print $0}' >> {$curltemp,,}
curl -sSL  --compressed "https://reddestdream.github.io/Projects/MinimalHosts/etc/MinimalHostsBlocker/minimalhosts" | grep -v '::' | grep -v '#' | cut -d' ' -f2 | awk '/[a-z]$/{print $0}' >> {$curltemp,,}
...
curl -sSL  --compressed "https://someonewhocares.org/hosts/zero/hosts" | grep -v '#' | grep -v '127.0.0.1' | grep -v '::' | grep -v 'broadcasthost'  | cut -d' ' -f2 | awk '/[a-z]$/{print $0}' >> {$curltemp,,}
...
curl -sSL  --compressed "http://sysctl.org/cameleon/hosts" | grep -v '#' | grep -vi 'localhost' | cut -f2 | cut -d' ' -f2 >> {$curltemp,,}
curl -sSL  --compressed "https://zerodot1.gitlab.io/CoinBlockerLists/hosts" | grep -v '#' | cut -d' ' -f2 >> {$curltemp,,}
...
curl -sSL  --compressed "http://winhelp2002.mvps.org/hosts.txt" | dos2unix | grep -v '#' | grep -vi 'localhost' | awk '/[a-z]$/{print $0}' | cut -d' ' -f2 >> {$curltemp,,}
...
cat $curltemp | grep -i 'doubleclick.com' | sort -u > doubleclick.com.list
